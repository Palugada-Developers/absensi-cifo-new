...
class CheckLateUi extends StatelessWidget
{
    CheckLateUi({super.key});

    final checkLateVM = Get.put(CheckLateVM());
                        ...
                        body: Obx(()
                            {
                                if (checkLateVM.isError.value)
                                {
                                    ...
                                    checkLateVM.isError.value = false;
                                }
                                            ...
                                            child: Padding(
                                                ...
                                                child: Column(
                                                    ...
                                                    children: [
                                                        ...
                                                        WidgetsForm(
                                                            controller: checkLateVM.reasonWrapper,
                                                            label: "Alasan Terlambat",
                                                            hint: "Ketik alasan datang terlambat Anda disini.",
                                                            helper: "Harap isi form diatas untuk melanjutkan absensi kehadiran.",
                                                            isObscure: false,
                                                            minLines: 3
                                                        ),
                                                        ...
                                                        ElevatedButton(
                                                            onPressed: ()
                                                            {
                                                                checkLateVM.handleRequest(context);
                                                            },
                                                            style: ButtonStyle(
                                                            ...
                                                            child: Row(
                                                                mainAxisAlignment: MainAxisAlignment.center,
                                                                children: [
                                                                    if (checkLateVM.isLoading.value)
                                                                    SpinKitFadingCircle(
                                                                        color: Colors.white,
                                                                        size: 80.sp
                                                                    )
